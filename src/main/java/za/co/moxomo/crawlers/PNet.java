...
public class PNet {
    ...
    private static final HashSet<String> crawledUrls = new HashSet<String>();
    private static final HashSet<String> savedJobs = new HashSet<String>();
    private static final String PNET = "http://www.pnet.co.za/jobs/all-jobs.html";
